...
const HomePage = () => {
  return (
    <div className="home-page">
      <header className="page__section home-page__header">
        ...
        <section className="page__section home-page__games">
          ...
          <article className="game">
            ...
            <div className="game__text">
              ...
              <p className="subtext limit-width">
                Repeat increasingly complex flashing sequences without failing
                even one step.
              </p>
            </div>
          </article>
          <article className="game">
            ...
            <div className="game__text">
              ...
              <p className="subtext limit-width">
                Stop the moving slider exactly inside the shrinking target zone.
              </p>
            </div>
          </article>
          <article className="game">
          ...
          <article className="game comming-soon">
            ...
            <p className="ibmplexmono subtext comming-soon__subtext">Comming soon</p>
          </article>
        </section>
      </main>
      <footer>
